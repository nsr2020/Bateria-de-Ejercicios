...
for (const usuario of users) {
  for (const sonido in usuario.favoritesSounds) {
    ...
    conteoSonidos[sonido] = (conteoSonidos[sonido] || 0) + 1; // con esto si tiene el elemento le suma 1 en cada vuelta.
  }
}


for (const sonido in conteoSonidos) {
  console.log(`El sonido ${sonido} ha sido agregado ${conteoSonidos[sonido]} veces.`);
}
